...
;(function( $, window, undefined ){
  ...
  Plugin.prototype.init = function (){
    ...
    ;if( typeof self.options.timer === 'number' ) (function(){
      var interval
      ...
      self.$el.on(pn+':shown', self.start)
    })()

    // Paginator
    ;if( s.paginatorItems ) (function(){
      var $pitems = find(s.paginatorItems)
